    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-grit-green to-grit-green-dark text-white py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-grit-gold-light mb-8 max-w-3xl mx-auto">
      ...
      <section className="bg-grit-green text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-grit-gold-light">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold text-grit-gold-light mb-2">500+</div>
              <p className="text-grit-gold-light">Schools</p>
            </div>
            <div>
              <div className="text-4xl font-bold text-grit-gold-light mb-2">50K+</div>
              <p className="text-grit-gold-light">Students</p>
            </div>
            <div>
              <div className="text-4xl font-bold text-grit-gold-light mb-2">100K+</div>
              <p className="text-grit-gold-light">Awards Given</p>
            </div>
            <div>
              <div className="text-4xl font-bold text-grit-gold-light mb-2">95%</div>
              <p className="text-grit-gold-light">Satisfaction Rate</p>
            </div>
          </div>
        </div>
      </section>
