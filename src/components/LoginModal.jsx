      ...
      <div className="relative bg-white rounded-lg p-6 sm:p-8 max-w-md w-[95%] max-h-[85vh] overflow-y-auto mx-4 shadow-xl">
        ...
        {!selectedRole ? (
          ...
          <>
            ...
            <h2 className="text-2xl font-bold text-[#032717] text-center mb-2">Welcome Back</h2>
            <p className="text-sm text-gray-600 text-center mb-8">Sign in to access your dashboard</p>
            
            <form onSubmit={handleLogin} className="space-y-6">
              {/* Username Field */}
              <div>
                <label htmlFor="username" className="block text-sm font-medium text-[#032717] mb-2">
                  Username
                </label>
                <input
                  type="text"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-br from-[#032717] to-[#054d2a] py-3.5 rounded-lg text-white font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <span className="text-gray-700 font-medium">Sign In with Google Classroom</span>
              </button>
              ...
              >
                ...
                <span className="text-gray-700 font-medium">Sign In with Microsoft SSO</span>
              </button>
            </div>
          </>
        ) : (
